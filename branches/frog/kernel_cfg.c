...
const TaskType Task_bg = 2;

extern void TASKNAME( Task1 )( void );
extern void TASKNAME( Task2 )( void );
extern void TASKNAME( Task_bg )( void );

static __STK_UNIT _stack_Task1[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Task2[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Task_bg[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 1, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000000, 0x00000001, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task1 ), TASKNAME( Task2 ), TASKNAME( Task_bg ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task1, (__STK_UNIT)_stack_Task2, (__STK_UNIT)_stack_Task_bg, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 4, 20, };
